...
namespace CompilerGUI
{
	public partial class MainForm : Form
	{
		...
		private void compileButton_Click(object sender, EventArgs e)
		{
			...
			if(genExe.Checked == true) ArgumentList.Add(string.Format("-o {0}", FixStringSpaces(exeName.Text)));
			ArgumentList.Add(FileToCompile);
		...
		public void ToggleAllControls(bool state)
		{
			...
			if(state)
			{
				if (genExe.Checked) exeName.Enabled = true;
				else exeName.Enabled = false;
			}
